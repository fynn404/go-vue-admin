...
type GradeHistory struct {
	...
	OldScore   *decimal.Decimal `gorm:"type:decimal(5,2)" json:"old_score,omitempty"` // 原分数
	NewScore   *decimal.Decimal `gorm:"type:decimal(5,2)" json:"new_score,omitempty"` // 新分数
